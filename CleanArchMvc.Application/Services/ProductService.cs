...
namespace CleanArchMvc.Application.Services
{
    public class ProductService : IProductService
    {
        ...
        {
            _productRepository = productRepository ?? //operador null coalescence, caso productRepository for nulo a variável _productRepository vai receber uma nova argumentException.
